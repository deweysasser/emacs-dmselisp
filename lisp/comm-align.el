...
;  functions: com-alig.doc
;  variables: com-alig.doc
...
;-- __John When asked to attend a court case, Father Moses took with
;him a leaking jug of water. Asked about it, he said: "You ask me to
;judge the faults of another, while mine run out like water behind
;me."
;
;                jcgs@uk.co.harlqn (UK notation) jcgs@harlqn.co.uk
;(most places) ...!mcvax!ukc!harlqn!jcgs (uucp - really has more
;stages, but ukc knows us) John Sturdy Telephone +44-223-872522
